...
-- local workbench_file = "SimpleSetUp.iob"
-- local ok = pcall(function()
--     simion.command(workbench_file)
-- end)

-- V = pa:potential(0, 0, 0)  -- test that the PA loaded correctly
-- print(string.format("Loaded PA file '%s', test potential at (0,0,0) = %.6f", pa.filename, V))

-- if not ok then
--     error("Failed to load the SIMION workbench: " .. workbench_file)
-- end
...
--     if simion and simion.wb and type(simion.wb.epotential) == "function" then
--         local ok, v = pcall(function()
--             return simion.wb:epotential(x, y, z)
--         end)
...
-- ============================================================
-- 4. Paste your export_basis function here (with timing)
-- ============================================================
...
for i = 1, n_electrodes do
    ...
    -- print("fast_adjust ran, current_electrode=" .. current_electrode .. ", adj_elect[1]=" .. adj_elect[1] .. ", adj_elect[2]=" .. adj_elect[2])
