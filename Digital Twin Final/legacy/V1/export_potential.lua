simion.command 'SimpleSetUp.iob' -- Load the SIMION workbench file
...
local file = assert(io.open("simion_potential_output.csv", "w"))

-- Write the CSV header
file:write("x,y,z,V\n")

print("Exporting V data... please wait.")
   ...
   for y = y_min, y_max, y_step do
      for z = z_min, z_max, z_step do
         ...
         if v then
            ...
            file:write(string.format("%f,%f,%f,0\n", x, y, z))
         end
