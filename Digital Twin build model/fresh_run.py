...
FRESH_DB_TEMPLATE = HERE / "beamline_study_fresh{}.db"
...
def main():
    ...
    # "_splat" suffix: the objective changed from maximize-hits to
    # minimize-mean-splat-distance -- old fresh DBs (beamline_study_freshN.db)
    # have the opposite optimization direction and must never be appended to.
    FRESH_DB = FRESH_DB_TEMPLATE.with_name(f"beamline_study_fresh{budget}_splat.db")
